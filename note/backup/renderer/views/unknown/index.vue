...
<template>
  ...
  >
    <v-row class="d-flex pb-0 mb-0 ml-0" justify="space-between">
      <v-card-title class="page-header mb-0 mt-4">Unknown UPC List</v-card-title>
    </v-row>
    ...
    <v-form ref="searchFormRef" :loading="isLoading" class="mx-2 pt-2 mb-0 pb-0">
      ...
      <v-row class="mb-4 pb-0 ml-3">
        ...
        ></v-select>
        <v-select
          v-model="formData.nameStatus"
          :items="Object.values(SimpleStatus)"
          return-object
          :placeholder="'Any Name Status'"
          class="mx-3"
          hide-details
          style="max-width: 200px"
          :bg-color="'white'"
        ...
        ></v-select>
        <v-select
          v-model="formData.manuStatus"
          :items="Object.values(SimpleStatus)"
          return-object
          :placeholder="'Any Manufacturer Status'"
          class="mx-3"
          hide-details
